...
Durante o ciclo de testes, utilizei o Chrome DevTools para realizar a solução das falhas encontradas. O objetivo foi realizar uma análise de causa raiz, distinguindo erros no Front-end de falhas estruturais de comunicação e persistência.
